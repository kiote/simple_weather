defmodule SimpleWeather.WeatherReceiver do
  ...
  def the_day_before_yesterday do
    ...
    |> Cache.maybe_get_from(weather_adapter(), &weather_adapter().time_machine()/1, :the_day_before_yesterday)
  end

  def two_days_before_yesterday do
    weather_adapter().params_for_time_machine(:two_days_before_yesterday)
    |> Cache.maybe_get_from(weather_adapter(), &weather_adapter().time_machine()/1, :two_days_before_yesterday)
  end
